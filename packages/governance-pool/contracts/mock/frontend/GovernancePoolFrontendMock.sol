...
//      */
//     mapping(address => mapping(uint256 => uint256[])) internal milestonesIdsInWhichBalanceChanged;
...
//             revert GovernancePool__NotInvestmentPool();
//         _;
//     }
...
//         uint256 investmentPoolId = getInvestmentPoolId(_investmentPool);
//         uint256[] memory milestonesIds = getMilestonesIdsInWhichBalanceChanged(
//             _investor,
//             investmentPoolId
//         );
...
//             milestonesIdsInWhichBalanceChanged[_investor][investmentPoolId].push(_milestoneId);
//         } else {
...
//         milestonesIdsInWhichBalanceChanged[_investor][investmentPoolId].pop();
...
//             milestonesIdsInWhichBalanceChanged[_msgSender()][investmentPoolId].push(
//                 currentMilestoneId
//             );
//         }

//         if (memActiveTokens[_recipient][investmentPoolId][currentMilestoneId] == 0) {
//             milestonesIdsInWhichBalanceChanged[_recipient][investmentPoolId].push(
//                 currentMilestoneId
//             );
//         }
...
//     function getMilestonesIdsInWhichBalanceChanged(address _investor, uint256 _investmentPoolId)
//         public
//         view
//         returns (uint256[] memory)
//     {
//         return milestonesIdsInWhichBalanceChanged[_investor][_investmentPoolId];
//     }
